...
// auto UringIoEngine::OpenAt(const UringIoOptions opts, int dfd, const char*
// path,
//                            int flags,
...
// auto UringIoEngine::Statx(const UringIoOptions opts, int dfd, const char*
// path,
...
//   UringIoType::Fallocate); handle->future = future.get(); handle->type =
//   UringIoType::Fallocate; io_uring_sqe* sqe = io_uring_get_sqe(&ring_);
